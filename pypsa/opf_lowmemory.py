...
from .opt_lowmemory import (get_bounds_pu, get_extendable_i, linexpr,
                            get_non_extendable_i, write_bound, write_constraint,
                            set_conref, set_varref, get_con, get_var, lookup,
                            nominals, reset_counter, expand_series, join_exprs)

from .pf import (find_cycles as find_cycles, _as_snapshots,
                 get_switchable_as_dense as get_as_dense)

from . import opt_lowmemory
...
def network_lopf(n, snapshots=None, solver_name="cbc",
    ...
    solve = getattr(opt_lowmemory, f'run_and_read_{solver_name}')
