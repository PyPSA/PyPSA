...
def define_generator_constraints(n, sns) -> None:
    ...
    Example:
    >>> define_generators_constraints(network, snapshots)
    This will add the energy sum constraints to the generators in the network model.
    """
    m = n.model
    c = "Generator"
    static = n.static(c)
    ...
    e_sum_min = n.df(c).loc[e_sum_min_set, "e_sum_min"]
    ...
    e_sum_max = n.df(c).loc[e_sum_max_set, "e_sum_max"]
