...
def define_operational_constraints_for_non_extendables(
    ...
    nominal_fix = c.as_xarray(c._operational_attrs["nom"], inds=fix_i)
...
def define_operational_constraints_for_committables(
    ...
    # parameters
    nominal = c.as_xarray(c._operational_attrs["nom"], inds=com_i)
...
def define_fixed_operation_constraints(
    ...
    active = c.as_xarray("active", sns, inds=fix.coords["name"].values)
