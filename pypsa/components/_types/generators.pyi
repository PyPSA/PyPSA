...
SeriesLike = Sequence[T] | pd.Series
...
class Generators:
    def add(
        ...
        p_nom_max: float | SeriesLike[float] = float("inf"),
        ...
        e_sum_min: float | SeriesLike[float] = float("-inf"),
        e_sum_max: float | SeriesLike[float] = float("inf"),
        ...
        lifetime: float | SeriesLike[float] = float("inf"),
        ...
        ramp_limit_up: float | SeriesLike[float] | ArrayLike = float("nan"),
        ramp_limit_down: float | SeriesLike[float] | ArrayLike = float("nan"),
