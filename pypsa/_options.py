...
class OptionsNode:
    ...
    def describe(self) -> None:
        ...
        general.allow_network_requests:
            Default: True
            Description: Allow PyPSA to make network requests. When False, ...

        Print the parameters options:

        >>> pypsa.options.params.describe() # doctest: +ELLIPSIS
        PyPSA Options
        =============
        statistics.nice_names:
            Default: True
            Description: Default value for the 'nice_names' parameter in ...
