...
network.add("Line", "line1", bus0="n1", bus1="n2", x=0.1, r=0.01, s_nom=0.5)
network.add("Line", "line2", bus0="n1", bus1="n3", x=0.1, r=0.01, s_nom=0.5)
...
network.add("Line", "line3", bus0="n4", bus1="n5", x=0.1, r=0.01, s_nom=0.5)
...
print("switching, so lad load1 is disconnected from line1 and connected to line3")
