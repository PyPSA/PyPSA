...
- **[:flag_us: pypsa-illinois](https://github.com/ucsusa/pypsa-illinois)**: Using PyPSA to model the Illionois electricity system for storage requirement analysis maintained by Union of Concerned Scientists (UCS).
