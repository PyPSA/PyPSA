...
* **[:flag_in: Serentica](https://www.serenticaglobal.com/)**, an Indian independent power producer (IPP) and project developer, uses PyPSA to create and assess round-the-clock power purchasement agreements (PPAs). See [YouTube](https://www.youtube.com/watch?v=Yz-6ZH3oFWA&list=PLz1RcE1NdLlHsbQoUXxJOVQ8IdEv9Ks5Z&index=8).
