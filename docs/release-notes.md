...
- Exclude `matplotlib` 3.11.0, which crashes faceted statistics plots with shared axes and scientific offset text (`ValueError: cannot convert float NaN to integer`, [matplotlib#31881](https://github.com/matplotlib/matplotlib/issues/31881)). The upstream fix lands in matplotlib 3.11.1. (<!-- md:pr 1781 -->)
