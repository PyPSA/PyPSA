...
- The `bus_carrier`, `carrier` and `groupby` arguments of the [statistics](./user-guide/statistics.md) methods now accept any list-like value, not just lists. (<!-- md:pr 1865 -->)
