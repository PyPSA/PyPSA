...
- Add [`n.statistics.capture_rate()`][pypsa.statistics.StatisticsAccessor.capture_rate], the market value of a component relative to the average market price. (<!-- md:pr 1925 -->)
