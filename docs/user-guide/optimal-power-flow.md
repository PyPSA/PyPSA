...
The first sum is over generators; the second sum is over stores and storage units. $\mu$ is the shadow price of the constraint, i.e. the $\mathrm{CO}_2$ price in this case.
