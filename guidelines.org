...
Generators.p_max or Generators["p_max"] returns a series
...
generators = pd.DataFrame(columns= ...., dtypes .....,index = gen_names)  #only contains time constant parts

generators.p_set = pd.DataFrame
