...
* `ACER <https://www.acer.europa.eu/>`_ (the Euroean Union Agency for the Cooperation of Energy Regulators) is establishing a consultative expert group on EU-wide flexibility needs assessments considering the open source solution PyPSA for `simulating and optimising modern energy systems  <https://www.acer.europa.eu/sites/default/files/documents/en/The_agency/Organisation/Expert_Groups/EG_Flexibility/Flexibility_EG_Open_Letter_2025.pdf>`_.
